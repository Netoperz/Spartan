...
//	Serial.println("");
		...
		rfidUid.toCharArray(message_buff, rfidUid.length()+1); //=== Create array for bluetooth link and HID keyboard
// 		Serial1.println(message_buff);  // Send array to bluetooth, This line only for bluetooth version
